 ...
 */
require_once(TEMPLATEPATH . '/functions/post_type_carousel_item.php');
require_once(TEMPLATEPATH . '/functions/meta_box_page_in_footer.php');
require_once(TEMPLATEPATH . '/functions/widget_logo.php');
require_once(TEMPLATEPATH . '/functions/widget_css_menu.php');
require_once(TEMPLATEPATH . '/functions/widget_css_nav_menu.php');
require_once(TEMPLATEPATH . '/functions/page_theme_options.php');
/**
 * Get breadcrumbs
 */
function get_the_breadcrumb($container = "li") 
{
	$str = "";
    if (!is_front_page()) 
    {
    	$str.= "<$container>";
        $str.= '<a href="'.get_option('home').'">'.__('Home').'</a>';
        $str.= "</$container>";
...
/**
 * Add css Class to "contact form 7"
 */
